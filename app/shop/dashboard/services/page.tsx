  ...
  const handleAddService = async () => {
    try {
      ...
      const response = await fetch(
        `${API_URL}/shop-owners/shops/${shopId}/services/`,
        {
          method: "POST",
          headers: {
...
function EditServiceModal({
  ...
  const handleUpdateService = async () => {
    try {
      ...
      const response = await fetch(
        `${API_URL}/shop-owners/shops/${shopId}/services/${service.id}`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
...
function DeleteServiceDialog({
  ...
  const handleDelete = async () => {
    try {
      const response = await fetch(
        `${API_URL}/shop-owners/shops/services/${service.id}`,
        {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${accessToken}`,
        ...
        const shopsWithServices = await Promise.all(
          shopsData.map(async (shop: Shop) => {
            const servicesResponse = await fetch(
              `${API_URL}/shop-owners/shops/${shop.id}/services/`,
              {
                headers: {
                  Authorization: `Bearer ${session.user.accessToken}`,
                },
        ...
        <ServiceModal
          ...
          onSuccess={() => {
            const refreshServices = async () => {
              ...
              try {
                const servicesResponse = await fetch(
                  `${API_URL}/shop-owners/shops/${selectedShopId}/services/`,
                  {
                    headers: {
                      Authorization: `Bearer ${session.user.accessToken}`,
                    },
